...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--with-pdf-bbox", action="store_true", help="Resolve citations to PDF page/bbox using a citation index")
    parser.add_argument("--citation-index", default="Projects/ESG/graph/citation_index/pdf_citation_index.jsonl")
    parser.add_argument("--render-highlights", action="store_true", help="Render cached PNG highlights for resolved PDF bbox citations")
