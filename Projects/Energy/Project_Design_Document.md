...
Ma trận này dùng để kiểm tra các mệnh đề, giả định và dữ liệu trọng yếu trong PDD bằng các tài liệu hiện có tại `Projects/Energy/ref/standards_and_reports`. Đây là bảng kiểm soát nội bộ, không phải ý kiến xác minh độc lập hoặc kết luận kiểm toán cuối cùng.

Ký hiệu kết quả:

* `Đã xác nhận`: Có nguồn phù hợp trong thư mục tham chiếu.
* `Xác nhận một phần`: Nguồn hiện có ủng hộ hướng tiếp cận, nhưng chưa đủ để kết luận tuân thủ hoàn toàn.
* `Chưa xác nhận`: Chưa có nguồn phù hợp trong thư mục tham chiếu.
* `Mâu thuẫn`: Nguồn hiện có mâu thuẫn với mệnh đề trong PDD.
* `Cần dữ liệu dự án`: Cần dữ liệu đo đạc/pilot hoặc dữ liệu vận hành thực tế.
* `Cần dữ liệu nhà cung cấp`: Cần catalogue, datasheet, bản vẽ, chứng nhận hoặc hồ sơ hiệu chuẩn từ nhà cung cấp.
* `Cần tiêu chuẩn có bản quyền`: Cần bản tiêu chuẩn chính thức/licensed hoặc review của VVB trước khi tuyên bố tuân thủ.

| ID | PDD claim/data | Location | Validation need | Reference | Result | Required action |
| --- | --- | --- | --- | --- | --- | --- |
| REF-001 | Dự án sử dụng ISO 14064-2 để định lượng giảm phát thải cấp dự án. | 1.1, 1.5, 6.2 | Kiểm tra ISO 14064-2 có phù hợp cho project-level GHG reduction không. | [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md), [SOURCE_INDEX.md](./ref/standards_and_reports/SOURCE_INDEX.md) | Cần tiêu chuẩn có bản quyền | Mua/tra cứu bản TCVN ISO 14064-2:2025 chính thức và yêu cầu VVB review methodology trước khi tuyên bố tuân thủ. |
| REF-002 | ISO 14067 dùng để gán dấu chân carbon cho từng tấn sản phẩm vận chuyển. | 1.5 | Kiểm tra hướng tiếp cận product carbon footprint và phân bổ logistics vào sản phẩm. | [GHG_Protocol_Product_Life_Cycle_Standard.md](./ref/standards_and_reports/GHG_Protocol_Product_Life_Cycle_Standard.md), [GHG_Protocol_Scope3_Calculation_Guidance.md](./ref/standards_and_reports/GHG_Protocol_Scope3_Calculation_Guidance.md) | Xác nhận một phần | Giữ như hướng hỗ trợ CFP/Scope 3; cần bản TCVN ISO 14067 chính thức nếu dùng làm claim tuân thủ. |
| REF-003 | Logistics emissions nên được tính theo ISO/TCVN 14083. | 1.1, 6.2, 7 | Kiểm tra chuẩn chính cho phát thải chuỗi vận chuyển. | [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md), [GLEC_Framework_v3.2_2025-10-21.md](./ref/standards_and_reports/GLEC_Framework_v3.2_2025-10-21.md), [CLECAT_Guide_to_ISO_14083_GHG_Transport_Sector.md](./ref/standards_and_reports/CLECAT_Guide_to_ISO_14083_GHG_Transport_Sector.md) | Đã xác nhận | Bổ sung ISO 14083/TCVN ISO 14083 làm chuẩn logistics chính trong phần methodology. |
| REF-004 | GHG Protocol operational control dùng cho organizational boundary. | 2.3 | Kiểm tra nguyên tắc operational control và phân loại phát thải tổ chức. | [ghg-protocol-revised.md](./ref/standards_and_reports/ghg-protocol-revised.md) | Xác nhận một phần | Giữ nguyên hướng tiếp cận, nhưng cần mapping rõ Scope 1/2/3 theo từng tài sản và hợp đồng vận hành. |
| REF-005 | Điện lưới tại trạm sạc thuộc Scope 2 của LeTRON. | 2.3, 6.2 | Kiểm tra phân loại Scope 2 và cách tính điện mua. | [Scope 2 Guidance.md](./ref/standards_and_reports/Scope%202%20Guidance.md), [ghg-protocol-revised.md](./ref/standards_and_reports/ghg-protocol-revised.md) | Xác nhận một phần | Tách rõ location-based và market-based; không tính điện tái tạo là 0 nếu chưa có cơ sở EAC/LCA phù hợp. |
| REF-006 | Dữ liệu logistics có thể hỗ trợ Scope 3 của FDI. | 1.5, 2.3, 3.2 | Kiểm tra Category 4/9 transportation and distribution. | [GHG_Protocol_Corporate_Value_Chain_Scope3_Standard.md](./ref/standards_and_reports/GHG_Protocol_Corporate_Value_Chain_Scope3_Standard.md), [GHG_Protocol_Scope3_Category4_Upstream_Transportation_Distribution.md](./ref/standards_and_reports/GHG_Protocol_Scope3_Category4_Upstream_Transportation_Distribution.md), [GHG_Protocol_Scope3_Category9_Downstream_Transportation_Distribution.md](./ref/standards_and_reports/GHG_Protocol_Scope3_Category9_Downstream_Transportation_Distribution.md) | Đã xác nhận | Giữ Scope 3/ESG là value proposition chính; xác định từng khách hàng dùng Category 4 hay Category 9. |
| REF-007 | Digital MRV phục vụ CBAM. | 1.3 | Kiểm tra logistics Scope 3 có nằm trong CBAM hiện hành không. | [2026-05-27_CBAM_Questions_and_Answers.md](./ref/standards_and_reports/CBAM_Research/2026-05-27_CBAM_Questions_and_Answers.md), [2023-12_CBAM_Implementation_Guidance_Installation_Operators_Outside_EU.md](./ref/standards_and_reports/CBAM_Research/2023-12_CBAM_Implementation_Guidance_Installation_Operators_Outside_EU.md) | Mâu thuẫn | Chuyển CBAM thành bối cảnh quy định carbon chung; không định vị logistics MRV là công cụ đáp ứng CBAM. |
| REF-008 | `CBAM Support` cho chứng thư Le-GCP. | 1.5 | Kiểm tra chứng thư logistics có thể giảm nghĩa vụ CBAM không. | [2024-05-30_CBAM_Implementation_Guidance_Importers.md](./ref/standards_and_reports/CBAM_Research/2024-05-30_CBAM_Implementation_Guidance_Importers.md), [2026-05-27_CBAM_Questions_and_Answers.md](./ref/standards_and_reports/CBAM_Research/2026-05-27_CBAM_Questions_and_Answers.md) | Mâu thuẫn | Loại bỏ claim CBAM support khỏi deliverable; thay bằng Scope 3, ESG, supplier reporting và product carbon footprint support. |
| REF-009 | Premium pricing dựa trên giá trị giảm/né thuế CBAM. | 1.6 | Kiểm tra cơ sở tài chính CBAM cho logistics xanh. | [2023-12_CBAM_Implementation_Guidance_Installation_Operators_Outside_EU.md](./ref/standards_and_reports/CBAM_Research/2023-12_CBAM_Implementation_Guidance_Installation_Operators_Outside_EU.md), [2024-05-30_CBAM_Implementation_Guidance_Importers.md](./ref/standards_and_reports/CBAM_Research/2024-05-30_CBAM_Implementation_Guidance_Importers.md) | Mâu thuẫn | Gỡ cơ sở định giá theo CBAM savings; thay bằng giá trị dữ liệu Scope 3, ESG procurement, audit readiness và giảm phát thải vận hành. |
| REF-010 | Chuyển giao `Emission Reduction Rights` để khách hàng báo cáo Scope 3 và CBAM. | 1.6 | Kiểm tra quyền giảm phát thải và cơ chế tránh double counting. | [GHG_Protocol_Corporate_Value_Chain_Scope3_Standard.md](./ref/standards_and_reports/GHG_Protocol_Corporate_Value_Chain_Scope3_Standard.md), [GHG_Protocol_Scope3_Calculation_Guidance.md](./ref/standards_and_reports/GHG_Protocol_Scope3_Calculation_Guidance.md) | Chưa xác nhận | Đổi thành “cung cấp dữ liệu phát thải/giảm phát thải hỗ trợ báo cáo”; không gọi là quyền tài sản carbon nếu chưa có chương trình carbon credit. |
| REF-011 | Công thức baseline/project emissions trong 6.2. | 6.2 | Kiểm tra công thức có đủ để thành methodology kiểm toán không. | [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md), [GLEC_Framework_v3.2_2025-10-21.md](./ref/standards_and_reports/GLEC_Framework_v3.2_2025-10-21.md), [GHG_Protocol_Scope3_Calculation_Guidance.md](./ref/standards_and_reports/GHG_Protocol_Scope3_Calculation_Guidance.md) | Xác nhận một phần | Bổ sung transport chain/TCE, allocation, empty trip, upstream energy, data quality và uncertainty trước khi xác minh. |
| REF-012 | `EF_Grid = 0.7228 kgCO2/kWh`. | 6.2, 6.2D | Kiểm tra hệ số lưới điện Việt Nam đang áp dụng. | [Vietnam_Grid_Emission_Factor_2023_CV1726_Metadata.html](./ref/standards_and_reports/Vietnam_Grid_Emission_Factor_2023_CV1726_Metadata.html), [Scope 2 Guidance.md](./ref/standards_and_reports/Scope%202%20Guidance.md) | Chưa xác nhận | File metadata hiện không chứa nội dung sử dụng được; cần thay bằng công văn/bản nguồn chính thức và cập nhật hệ số trước khi tính toán. |
| REF-013 | `EF_Diesel = 2.68 kgCO2/lít`. | 6.2, 6.2D | Kiểm tra hệ số diesel và cách quy đổi theo nhiên liệu. | [532253.md](./ref/standards_and_reports/532253.md), [V2_3_Ch3_Mobile_Combustion.md](./ref/standards_and_reports/2006gls_all_in/2_Volume2/V2_3_Ch3_Mobile_Combustion.md) | Xác nhận một phần | Dùng hệ số chính thức theo năng lượng/nhiên liệu và quy đổi bằng NCV/density; không chỉ ghi hệ số lít nếu không có bảng quy đổi. |
| REF-014 | `EF_Solar = 0`, `EF_Wind = 0`, `EF_Methanol = 0`. | 6.2D | Kiểm tra claim phát thải bằng 0 cho nguồn điện/nhiên liệu sạch. | [Scope 2 Guidance.md](./ref/standards_and_reports/Scope%202%20Guidance.md), [GHG_Protocol_Product_Life_Cycle_Standard.md](./ref/standards_and_reports/GHG_Protocol_Product_Life_Cycle_Standard.md), [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md) | Chưa xác nhận | Thay bằng location-based/market-based hoặc lifecycle factor; chỉ dùng 0 khi có hồ sơ nguồn gốc và phương pháp cho phép. |
| REF-015 | Solar/wind/Bio-Methanol tạm tính 0 khi có hồ sơ nguồn gốc và LCA phù hợp. | 6.2 | Kiểm tra điều kiện dùng yếu tố nguồn gốc và LCA. | [Scope 2 Guidance.md](./ref/standards_and_reports/Scope%202%20Guidance.md), [GHG_Protocol_Product_Life_Cycle_Standard.md](./ref/standards_and_reports/GHG_Protocol_Product_Life_Cycle_Standard.md) | Xác nhận một phần | Giữ như điều kiện tương lai; không dùng trong kết quả pilot cho đến khi có evidence pack năng lượng và LCA. |
| REF-016 | CAMC/Farizon battery capacity và điện năng tiêu thụ `1.30`, `0.60 kWh/km`. | 2.1, 4, 6.2D | Kiểm tra thông số phương tiện. | [SOURCE_INDEX.md](./ref/standards_and_reports/SOURCE_INDEX.md) | Cần dữ liệu nhà cung cấp | Liên kết catalogue/datasheet xe, test report hoặc log pilot; không xác nhận bằng standards folder. |
| REF-017 | Diesel baseline `0.25`, `0.18 lít/km` và `Alpha_Load = 0.005`. | 6.2, 6.2D | Kiểm tra baseline diesel theo tuyến, tải trọng và điều kiện vận hành. | [GLEC_Framework_v3.2_2025-10-21.md](./ref/standards_and_reports/GLEC_Framework_v3.2_2025-10-21.md), [GHG_Protocol_Scope3_Calculation_Guidance.md](./ref/standards_and_reports/GHG_Protocol_Scope3_Calculation_Guidance.md) | Cần dữ liệu dự án | Thu thập dữ liệu diesel đối chứng, e-waybill, tuyến, tải, tiêu thụ thực tế hoặc benchmark có nguồn. |
| REF-018 | `CF_Solar = 14.60%`, `CF_Wind = 29.90%`. | 6.2D | Kiểm tra hệ số công suất theo địa điểm Quảng Ninh/Uông Bí. | [SOURCE_INDEX.md](./ref/standards_and_reports/SOURCE_INDEX.md) | Cần dữ liệu dự án | Cần dữ liệu bức xạ/gió, thiết kế hệ thống, mô phỏng PV/wind hoặc log sản lượng thực tế. |
| REF-019 | `Eff_VFB = 80%`, `Eff_BESS = 90%`, `Loss_Transmission = 5%`, `Eff_Charge = 94%`. | 6.2D | Kiểm tra hiệu suất thiết bị và tổn thất hệ thống. | [SOURCE_INDEX.md](./ref/standards_and_reports/SOURCE_INDEX.md) | Cần dữ liệu nhà cung cấp | Cần datasheet, nghiệm thu kỹ thuật, calibration hoặc log vận hành. |
| REF-020 | Trạm sạc MCS `5 x 1.2 MW`, OCPP 2.0.1, công tơ Class 0.5S. | 2.1, 4, 5.1 | Kiểm tra thông số hạ tầng sạc và đo lường. | [SOURCE_INDEX.md](./ref/standards_and_reports/SOURCE_INDEX.md) | Cần dữ liệu nhà cung cấp | Bổ sung datasheet trạm sạc, công tơ, chứng nhận OCPP và hồ sơ kiểm định đo lường. |
| REF-021 | GPS, CAN Bus, cảm biến tải trọng trục là nguồn dữ liệu MRV. | 2.2, 7.1 | Kiểm tra yêu cầu dữ liệu vận hành và nguồn primary data. | [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md), [GLEC_Framework_v3.2_2025-10-21.md](./ref/standards_and_reports/GLEC_Framework_v3.2_2025-10-21.md) | Xác nhận một phần | Bổ sung schema, data lineage, calibration, missing-data rule và quyền truy cập dữ liệu nguồn. |
| REF-022 | Telemetry 5 giây/lần. | 5.2, 7.1 | Kiểm tra tần suất thu thập dữ liệu có cần theo chuẩn không. | [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md), [GLEC_Framework_v3.2_2025-10-21.md](./ref/standards_and_reports/GLEC_Framework_v3.2_2025-10-21.md) | Cần dữ liệu dự án | Giữ là thiết kế control nội bộ; cần pilot chứng minh tính ổn định, dung lượng và lợi ích audit. |
| REF-023 | Completeness tối thiểu 95%. | 8.1 | Kiểm tra ngưỡng chất lượng dữ liệu. | [GLEC_Framework_v3.2_2025-10-21.md](./ref/standards_and_reports/GLEC_Framework_v3.2_2025-10-21.md), [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md) | Cần dữ liệu dự án | Xem như ngưỡng quản trị nội bộ; cần VVB review và pilot data để xác nhận khả thi. |
| REF-024 | Sai lệch đối soát điện dưới 2%. | 8.1 | Kiểm tra ngưỡng accuracy giữa storage/hub/vehicle. | [Scope 2 Guidance.md](./ref/standards_and_reports/Scope%202%20Guidance.md), [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md) | Cần dữ liệu dự án | Cần meter accuracy, calibration, uncertainty budget và dữ liệu pilot; không coi 2% là chuẩn bên ngoài. |
| REF-025 | Hash/LeDB phát hiện chỉnh sửa hồi tố và hỗ trợ kiểm toán. | 2.2, 5.2, 7.2, 9.1 | Kiểm tra vai trò data integrity control. | [GHG_Protocol_Product_Life_Cycle_Standard.md](./ref/standards_and_reports/GHG_Protocol_Product_Life_Cycle_Standard.md), [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md) | Xác nhận một phần | Giữ hash như audit trail kỹ thuật; không mô tả là xác minh độc lập hoặc bằng chứng dữ liệu đầu vào đúng. |
| REF-026 | Auditor Gateway cho kiểm toán viên độc lập. | 1.4, 7.3, 9.2 | Kiểm tra đây là chức năng hệ thống, không phải validation bên ngoài. | [SOURCE_INDEX.md](./ref/standards_and_reports/SOURCE_INDEX.md) | Cần dữ liệu dự án | Mô tả là implementation design; cần access control, logging, evidence export và scope làm việc với VVB. |
| REF-027 | Dùng phiếu cân hoặc e-waybill khi cảm biến tải trọng lỗi. | 8.2 | Kiểm tra fallback evidence cho tải trọng. | [GHG_Protocol_Scope3_Calculation_Guidance.md](./ref/standards_and_reports/GHG_Protocol_Scope3_Calculation_Guidance.md), [GLEC_Framework_v3.2_2025-10-21.md](./ref/standards_and_reports/GLEC_Framework_v3.2_2025-10-21.md) | Xác nhận một phần | Bổ sung thứ tự ưu tiên dữ liệu, điều kiện dùng fallback, log ngoại lệ và yêu cầu chữ ký số/chứng từ gốc. |
| REF-028 | Le-GCP là chứng thư số giảm phát thải. | 1.4, 7.2, 9.1 | Kiểm tra phạm vi “chứng thư” có bị hiểu thành carbon credit không. | [GHG_Protocol_Corporate_Value_Chain_Scope3_Standard.md](./ref/standards_and_reports/GHG_Protocol_Corporate_Value_Chain_Scope3_Standard.md), [GHG_Protocol_Product_Life_Cycle_Standard.md](./ref/standards_and_reports/GHG_Protocol_Product_Life_Cycle_Standard.md) | Chưa xác nhận | Đổi thành “digital emissions report/evidence package”; không gọi carbon certificate/credit nếu chưa theo chương trình được công nhận. |
| REF-029 | ISO/IEC 27001 & TISAX cho an ninh thông tin. | 1.5 | Kiểm tra có nguồn an ninh thông tin trong thư mục reference không. | [SOURCE_INDEX.md](./ref/standards_and_reports/SOURCE_INDEX.md) | Chưa xác nhận | Bổ sung tài liệu ISO/IEC 27001/TISAX riêng hoặc chuyển thành mục định hướng chưa xác nhận. |
| REF-030 | Các bảng tính 1 năm là ví dụ minh họa, chưa phải dữ liệu xác minh. | 6.1, 6.2 | Kiểm tra trạng thái số liệu kế hoạch/pilot. | [TCVN_ISO_14083_2025.md](./ref/standards_and_reports/TCVN_ISO_14083_2025.md), [GLEC_Framework_v3.2_2025-10-21.md](./ref/standards_and_reports/GLEC_Framework_v3.2_2025-10-21.md) | Cần dữ liệu dự án | Giữ nhãn minh họa; không dùng làm kết quả phát thải chính thức cho đến khi có pilot data và verification scope. |
