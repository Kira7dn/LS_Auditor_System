...
*   **Bài 3.1: Thiết kế Luật nguyên tử (Atomic Rules).** Cách viết file luật quản trị (GEMINI.md) để ép AI tuân thủ các checklist cứng (Ví dụ: Định dạng ngày tháng, cấu trúc đầu mục báo cáo, cấm sử dụng từ ngữ sáo rỗng).
...
2.  **Thiết kế Rule:** Viết 01 file luật quản trị (GEMINI.md) chuyên biệt để chẩn đoán lỗi trong quy trình kế toán hoặc vận hành kho.
