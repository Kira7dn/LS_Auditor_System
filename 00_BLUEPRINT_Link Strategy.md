...
- ![1777359182439](image/00_BLUEPRINT_LinkStrategy/1777359182439.png)

```mermaid
graph TD
    L1["<b>LAYER 1: CLARITY</b><br/>(Audit & Diagnosis)"]
    L2["<b>LAYER 2: INTERVENTION</b><br/>(Recovery, Rationalization, Build)"]
    L3["<b>LAYER 3: COMMERCIALIZATION</b><br/>(Productization & Business Model Design)"]

    R1([$ DOANH THU AUDIT])
    R2([$$ DOANH THU CAN THIỆP])
    R3([$$$ DOANH THU ĐỊNH KỲ])

    L1 --> |"Chốt pain có urgency"| R1
    L1 --> |"Trích xuất intervention logic"| L2

    L2 --> |"Bàn giao module / system fix"| R2
    L2 --> |"Chọn pattern đáng productize"| L3

    L3 --> |"Sản phẩm / Recurring model"| R3

    style L1 fill:#eef6ff,stroke:#003366,stroke-width:2px
    style L2 fill:#fff9e6,stroke:#ffb800,stroke-width:2px
    style L3 fill:#f0fff0,stroke:#2e8b57,stroke-width:2px
    style R1 fill:#fff,stroke:#333,stroke-dasharray: 5 5
    style R2 fill:#fff,stroke:#333,stroke-dasharray: 5 5
    style R3 fill:#fff,stroke:#333,stroke-dasharray: 5 5
```
